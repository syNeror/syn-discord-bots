...
const log = require('../data/log.json'); // {"ksmsg-log":"KANAL_ID"} veya {"ksmessage-log":"KANAL_ID"}
...
module.exports = {
  ...
  async execute(oldMessage, newMessage) {
    try {
      ...
      const logChId = log['</ KATESHİ LOG />']['ksmessage-log'];
      if (!logChId) return;
      ...
      // İçerikler (Message Content intent yoksa boş gelebilir)
